...
(function (root) {
  ...
  // surfaced without caring which underlying engine produced them.
  function recordStepAttempt(progress, label, correct) {
  ...
  function recordProblemCompletion(progress, { allFirstTryCorrect, timedSeconds }) {
